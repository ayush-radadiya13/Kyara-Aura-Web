      ...
      {links.map(({ key, label, href }) => {
        ...
        return (
          <a
            ...
            aria-label={label}
            className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-black/10 bg-white/70 text-black transition hover:-translate-y-0.5 hover:bg-white hover:shadow-sm"
          >
            <Icon />
          </a>
        );
