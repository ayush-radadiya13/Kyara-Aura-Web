...
/** @type {Record<string, { label: string; type: string; placeholder: string; autoComplete?: string; icon?: 'mail' | 'lock' | 'user' | 'phone' }>} */
...
/** Indian mobile: 10 digits, starts with 6–9 (no country code in the input). */
