...
export const useCartStore = create(
  persist(
    (set, get) => ({
      ...
      /**
       * @param {{ items?: CartItem[], total?: number, itemCount?: number, buyTwoGetOneDiscountAmount?: number, orderSummary?: object | null }} cart
       */
      setCart: (cart) => {
        ...
        set({
          ...
          orderSummary: cart.orderSummary ?? null,
        });
      },
      ...
      clearCart: () =>
        set({ items: [], total: 0, itemCount: 0, buyTwoGetOneDiscountAmount: 0, orderSummary: null }),
