...
'Buy 1 more product and get 1 FREE!';

export const BUY_TWO_GET_ONE_SELECT_FREE_MESSAGE =
'Your FREE product is ready. Please select it now!';

export const BUY_TWO_GET_ONE_TICKET_DEFAULT_MESSAGE =
'Buy 2 Get 1 Free !! See Offer Items';
...
export function getBuyTwoGetOneTicketMessage({
  ...
  eligibleCount = null,
  hasFreeProduct = null,
  defaultMessage = BUY_TWO_GET_ONE_TICKET_DEFAULT_MESSAGE,
} = {}) {
